...
let useStrokes = true;
let strokeVWeight = 0.00875;
let cubeDirections = helper.range(1,7);
let cubeLengthLow = 1;
let cubeLengthHigh = 3;
...
function preload() {
    ...
    //https://artvee.com/dl/chrysanthemum-golden-queen-prince-albert/
    img = loadImage(`../images/botanical/Chrysanthemum–Golden-Queen--Prince-Albert-1852-1861.jpg`);
}
