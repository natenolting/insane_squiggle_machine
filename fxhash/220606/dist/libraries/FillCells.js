class FillCells {
    ...
    shuffleArray = function(array) {
      return this.helper.shuffleArray(array);
    }

    colorList = function(random = false) {

      if (random) {
        return this.shuffleArray([...this.colors])
      }

      return this.coinFlip() ?  this.colors : this.colors.reverse();
    };
    ...
    pixelated = function (splitW = 10, splitH = 10, shape = "square") {
        ...
        for (var r = 0; r < splitW; r++) {
            for (var c = 0; c < splitH; c++) {
                let thisColor = this.colors[round(map(fxrand(), 0, 1, 0, this.colors.length - 1))]
                this.cG.noStroke();
                this.cG.fill(thisColor.h, thisColor.s, thisColor.l, this.opacity);
                switch (shape) {
                    case "diamond":
                        this.cG.beginShape();
                        vertex((this.cell.x + r * w) + w / 2, this.cell.y + c * h);
                        vertex((this.cell.x + r * w) + w, (this.cell.y + c * h) + h / 2);
                        vertex((this.cell.x + r * w) + w / 2, (this.cell.y + c * h) + h);
                        vertex((this.cell.x + r * w), (this.cell.y + c * h) + h / 2);
